...
public interface ClienteCadastroMapper {
    ...
    @Mappings({
            @Mapping(source = "clienteSaida",target = "cliente"),
    ...
    ClienteCadastroSaida mapToSaida(ClienteSaida clienteSaida, DadosAdicionaisSaida dadosAdicionaisSaida,
    ...
    ClienteCadastroSaida mapToSaidaFromEntity(ClienteEntity clienteEntity, DadosAdicionaisEntity dadosAdicionaisEntity,
